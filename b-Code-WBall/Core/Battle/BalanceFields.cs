...
public static class BalanceFields
{
    ...
    [
        ...
        B("FriendlyAssistVisualEnabled", "visual", "同阵营助力与回收", "显示助力连线", "balance.assist",
            "即时 / 纯视觉"),
        D("FriendlyAbsorbSmallRate", "smallRate", "同阵营助力与回收", "小球吸收兼容值(即时吸收不使用)", 0, 10, "balance.assist",
            "即时 / 低速机制"),
        ...
        D("ShieldSlotGainPerValue", "slotGain", "护罩与触杀", "护盾槽每点积分倍率", 0, 1_000_000, "balance.shield",
            "即时 / 两者; 0~100 为可抵消点倍率,较大旧值按原始护盾单位兼容"),
